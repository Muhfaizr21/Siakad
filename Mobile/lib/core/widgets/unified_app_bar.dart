...
class UnifiedAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  @override
  Size get preferredSize => Size.fromHeight(isExpandable ? expandedHeight + 20 : 100);
...
class UnifiedStaticAppBar extends StatelessWidget implements PreferredSizeWidget {
  final String title;
  final List<Widget>? actions;
  final bool showBackButton;
  final bool showNotification;
