class OrmawaAnnouncement {
  ...
  factory OrmawaAnnouncement.fromJson(Map<String, dynamic> json) {
    return OrmawaAnnouncement(
      ...
      tanggalMulai: DateTime.tryParse(json['TanggalMulai'] ?? json['tanggalMulai'] ?? json['tanggal_mulai'] ?? ''),
      tanggalSelesai: DateTime.tryParse(json['TanggalSelesai'] ?? json['tanggalSelesai'] ?? json['tanggal_selesai'] ?? ''),
    );
  }
