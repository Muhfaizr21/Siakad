...
class _OrmawaAbsensiSuccessScreenState extends State<OrmawaAbsensiSuccessScreen> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildDetailRow('Nama', widget.studentName, Icons.person_outline_rounded),
                          const Padding(
                          ...
                          _buildDetailRow('Waktu', dateFormat.format(widget.timestamp), Icons.access_time_rounded),
                        ],
                      ),
                    ),
                  ],
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          // Go back twice (close success screen, then close scanner)
                          int count = 0;
