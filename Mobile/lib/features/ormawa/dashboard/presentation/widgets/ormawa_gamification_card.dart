...
class OrmawaGamificationCard extends StatelessWidget {
  ...
  _GamificationTheme _getTheme(int rank) {
    if (rank == 1) {
      ...
      return _GamificationTheme(
        ...
        iconBgColor: Colors.orange.withAlpha(30),
  ...
  Widget build(BuildContext context) {
    ...
    final progress = total > 0 ? ((total - peringkat + 1) / total).clamp(0.0, 1.0) : 0.0;
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.emoji_events_rounded, color: theme.iconColor, size: 24),
                ),
            ...
            Row(
              children: [
                ...
                Container(width: 1, height: 40, color: theme.textColor.withAlpha(50)),
            ...
            Row(
              ...
              children: [
                Text(
                  'Bawah',
                  style: AppTextStyles.labelSm.copyWith(color: theme.textColor, fontSize: 9),
                ),
                Text(
                  'Top 1',
                  style: AppTextStyles.labelSm.copyWith(color: theme.titleColor, fontSize: 9, fontWeight: FontWeight.bold),
                ),
              ],
            )
          ],
