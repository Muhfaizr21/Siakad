...
class _OrmawaSettingsScreenState extends State<OrmawaSettingsScreen> {
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                _buildSwitchTile('Approval Proposal', 'Terima notifikasi status proposal', _notifApproval, (v) => setState(() => _notifApproval = v)),
                _buildSwitchTile('Update Keuangan', 'Notifikasi setiap mutasi kas masuk', _notifFinance, (v) => setState(() => _notifFinance = v)),
                _buildSwitchTile('Aspirasi Anggota', 'Notifikasi setiap ada keluhan baru', _notifAspiration, (v) => setState(() => _notifAspiration = v)),
  ...
  Widget _buildSectionHeader(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: AppTextStyles.labelSm.copyWith(color: const Color(0xFF94A3B8), fontWeight: FontWeight.w900, letterSpacing: 1.5, fontSize: 10),
      ),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(subtitle, style: AppTextStyles.labelSm.copyWith(color: const Color(0xFF94A3B8))),
              ],
            ),
          ),
          Switch(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: TextButton.icon(
          ...
          label: Text(
            'KELUAR PORTAL',
            style: AppTextStyles.labelMd.copyWith(color: Colors.red, fontWeight: FontWeight.w900, letterSpacing: 1),
          ),
