  ...
  Future<bool> createScreening({
    ...
    try {
      final data = {
        ...
        if (tanggalScreening != null) 'tanggal': "${tanggalScreening.year.toString().padLeft(4, '0')}-${tanggalScreening.month.toString().padLeft(2, '0')}-${tanggalScreening.day.toString().padLeft(2, '0')}",
