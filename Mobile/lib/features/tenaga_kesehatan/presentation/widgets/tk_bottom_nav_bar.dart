...
class _TkBottomNavBarState extends State<TkBottomNavBar> with SingleTickerProviderStateMixin {
            ...
            child: SafeArea(
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(1, Icons.schedule_rounded, 'Jadwal', themeProvider),
                  _buildNavItem(2, Icons.event_note_rounded, 'Booking', themeProvider),
                  _buildNavItem(3, Icons.people_alt_rounded, 'Pasien', themeProvider),
                  _buildNavItem(4, Icons.settings_rounded, 'Setelan', themeProvider),
                ],
              ),
            ),
          ),
