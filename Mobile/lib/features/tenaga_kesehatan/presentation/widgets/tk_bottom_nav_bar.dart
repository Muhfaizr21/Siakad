...
class _TkBottomNavBarState extends State<TkBottomNavBar> with SingleTickerProviderStateMixin {
  ...
  // Hardcoded Navy Blue BKU untuk consistency
            ...
            child: SafeArea(
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(1, Icons.schedule_rounded, 'Jadwal'),
                  _buildNavItem(2, Icons.event_note_rounded, 'Booking'),
                  _buildNavItem(3, Icons.people_alt_rounded, 'Pasien'),
