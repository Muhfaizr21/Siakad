...
import 'package:bkuhub_mobile/features/tenaga_kesehatan/presentation/widgets/tk_bottom_nav_bar.dart';
...
class TkMainScreenState extends State<TkMainScreen> {
  ...
  final List<Widget> _pages = [
    ...
    const TkScheduleScreen(showBackButton: false),
    const TkBookingScreen(),
    const TkPatientListScreen(showBackButton: false),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: TkBottomNavBar(
