...
class _ApplyScholarshipScreenState extends State<ApplyScholarshipScreen> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              FadeInAnimation(
                delay: 0.2,
                child: _buildSectionTitle('Data Akademik'),
              ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        FadeInAnimation(
                          delay: 0.5,
                          child: _buildLabel('IPK Terakhir'),
                        ),
                        FadeInAnimation(
                          delay: 0.55,
                          child: _buildTextField(
              ...
              FadeInAnimation(
                delay: 0.6,
                child: _buildSectionTitle('Motivasi & Alasan'),
              ),
              ...
              FadeInAnimation(
                delay: 0.7,
                child: _buildSectionTitle('Dokumen Pendukung'),
              ),
              const SizedBox(height: 16),
              FadeInAnimation(
                delay: 0.75,
  ...
  Widget _buildTextArea(TextEditingController controller, String hint) {
    return TextFormField(
      ...
      validator:
          (val) => val == null || val.isEmpty ? 'Mohon isi alasan kamu' : null,
    );
  }
