...
class _PsychologistReportsScreenState extends State<PsychologistReportsScreen> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Pilih jenis dan periode laporan',
                                  style: const TextStyle(
                                    fontSize: 12,
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: ElevatedButton.icon(
                                  ...
                                  isCreating
                                      ...
                                      : () async {
                                        ...
                                        final success = await Provider.of<
                                          CounselingProvider
                                        >(context, listen: false).createReport(
                                          tipe: selectedTipe,
                                          periode: periode,
                                        );
                                        if (ctx.mounted) {
                              ...
                              label: Text(
                                isCreating ? 'Membuat...' : 'Buat Laporan PDF',
                                style: const TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15,
                                ),
            ...
            builder:
                (context, setDialogState) => AlertDialog(
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed:
                          () => Navigator.pop(ctx, DateTime(selectedYear)),
                      child: const Text('Pilih'),
                    ),
                  ],
                ),
  ...
  void _downloadReport(Map<String, dynamic> report) async {
    ...
    if (reportId.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('ID laporan tidak valid')));
      return;
    }
