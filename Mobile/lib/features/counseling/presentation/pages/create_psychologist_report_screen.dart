...
class CreatePsychologistReportScreen extends StatefulWidget {
  ...
  @override
  State<CreatePsychologistReportScreen> createState() => _CreatePsychologistReportScreenState();
}

class _CreatePsychologistReportScreenState extends State<CreatePsychologistReportScreen> {
  final _formKey = GlobalKey<FormState>();
  String _selectedType = 'Laporan Bulanan';
  final List<String> _reportTypes = ['Laporan Bulanan', 'Laporan Kasus', 'Evaluasi Program', 'Lainnya'];
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildTextField('Judul Laporan', 'Contoh: Rekap Sesi Bulan Mei', icon: Icons.title_rounded),
                    const SizedBox(height: 16),
                    _buildTextField('Periode', 'Pilih bulan/tanggal', icon: Icons.calendar_month_rounded, isReadOnly: true),
                    
                    const SizedBox(height: 32),
                    _buildSectionTitle('Detail & Catatan'),
                    const SizedBox(height: 16),
                    _buildTextField('Deskripsi (Opsional)', 'Tulis rangkuman atau catatan penting...', maxLines: 5),
  ...
  Widget _buildTextField(String label, String hint, {IconData? icon, int maxLines = 1, bool isReadOnly = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          ...
          children: [
            Expanded(
              ...
              child: OutlinedButton(
                onPressed: () {
                  context.pop();
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Laporan disimpan sebagai draft')));
                },
                ...
                child: const Text('Simpan Draft', style: TextStyle(fontWeight: FontWeight.w900, color: AppColors.primary)),
              ),
            ),
            ...
            Expanded(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Buat Laporan', style: TextStyle(fontWeight: FontWeight.w900)),
              ),
            ),
          ],
        ),
