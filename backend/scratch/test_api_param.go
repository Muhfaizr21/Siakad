...
func main() {
	...
	fullURL := fmt.Sprintf("https://api-pddikti.kemdiktisaintek.go.id/pencarian/mhs/%s?limit=1000", url.PathEscape(keyword))
	...
	fmt.Printf("Total results with ?limit=1000: %d\n", len(mhsList))
}
