...
func ResetTheme(c *fiber.Ctx) error {
	...
	for key, value := range defaults {
		switch key {
		case "color_primary":       theme.ColorPrimary = value
		case "color_secondary":     theme.ColorSecondary = value
		case "color_accent":        theme.ColorAccent = value
		case "color_background":    theme.ColorBackground = value
		case "color_surface":       theme.ColorSurface = value
		case "color_text_primary":  theme.ColorTextPrimary = value
		case "color_text_muted":    theme.ColorTextMuted = value
		case "color_h1":           theme.ColorH1 = value
		case "color_h2":           theme.ColorH2 = value
		case "color_h3":           theme.ColorH3 = value
		...
		case "button_radius":       theme.ButtonRadius = value
		case "color_success":      theme.ColorSuccess = value
		case "color_warning":      theme.ColorWarning = value
		case "color_error":        theme.ColorError = value
		case "color_info":         theme.ColorInfo = value
		case "color_border":        theme.ColorBorder = value
		case "color_border_muted":  theme.ColorBorderMuted = value
		}
	}
