        ...
        <div className="px-6 py-6 flex items-center justify-between border-b border-white/10 shrink-0">
          <Link to="/ormawa" className="flex items-center gap-3.5 group">
            ...
            <div className="flex flex-col leading-tight overflow-hidden max-w-[140px]">
              <span className="text-sm font-extrabold uppercase tracking-wider truncate font-headline" style={{ color: 'var(--theme-sidebar-text)' }}>
                {identity.alias || identity.name}
              </span>
              <span className="text-[10px] font-bold uppercase tracking-widest font-headline" style={{ color: 'color-mix(in srgb, var(--theme-sidebar-text) 70%, var(--theme-secondary))' }}>Portal Ormawa</span>
            </div>
          </Link>
          <button
            onClick={() => setIsOpen(false)}
