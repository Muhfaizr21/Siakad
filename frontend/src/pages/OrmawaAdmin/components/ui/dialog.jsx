  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed left-[50%] translate-x-[-50%] z-50 grid w-[calc(100%-2rem)] sm:max-w-lg gap-4 rounded-[2rem] border p-0 shadow-2xl duration-200 top-4 translate-y-0 sm:top-[50%] sm:translate-y-[-50%] max-h-[calc(100dvh-2rem)] sm:max-h-[90dvh] overflow-y-auto',
          className,
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          ...
          >
            <XIcon className="size-5 stroke-[2.5px]" />
