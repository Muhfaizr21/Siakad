...
export function DataTable({
 ...
 // Robust key extraction: try exact, lowercase, and capitalized
 ...
 {onExport && (
 <Button onClick={onExport} variant="outline" className="h-11 px-6 rounded-2xl font-black text-[10px] tracking-[0.2em] bg-white text-slate-700 border-slate-200/60 hover:bg-slate-50 shadow-sm gap-2.5 transition-all hover:scale-[1.02] active:scale-95 group">
 ...
 <span className="text-[10px] tracking-[0.2em]">{addLabel ||"Tambah"}</span>
 </Button>
 )}
 </div>
 </div>
 ...
 className={`px-8 py-5 font-black text-[10px] text-slate-400 font-headline select-none tracking-[0.2em] ${!col.disableSort ? 'cursor-pointer hover:text-slate-900 group' : ''} ${col.className}`}
 >
 ...
 {actions && <TableHead className="px-8 py-5 font-black text-[10px] text-slate-400 font-headline text-right tracking-[0.2em]">Otomasi</TableHead>}
 </TableRow>
 </TableHeader>
 <TableBody>
 {loading ? (
 ...
 <p className="font-black text-[11px] tracking-widest text-slate-900 font-headline">Data Tidak Ditemukan</p>
 <p className="text-[10px] font-black text-slate-400 tracking-widest">Coba ubah kata kunci atau filter pencarian Anda</p>
 </div>
 </div>
 </TableCell>
 </TableRow>
 ...
 <p className="text-[10px] font-bold text-slate-400 tracking-[0.1em] font-headline">Showing Results</p>
 <p className="text-[11px] font-black text-slate-900 font-headline ">
 ...
 <div className="flex items-center gap-2">
 <span className="text-[9px] font-black text-slate-400 tracking-widest leading-none font-headline">Baris :</span>
 ...
 className="h-10 px-5 rounded-2xl border-slate-200 bg-white text-slate-600 font-black text-[9px] tracking-[0.2em] shadow-sm disabled:opacity-40 hover:bg-slate-50 transition-all hover:-translate-x-0.5"
 >
