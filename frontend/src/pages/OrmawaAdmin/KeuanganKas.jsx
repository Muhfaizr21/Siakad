...
export default function KeuanganKas() {
 ...
 <span className="material-symbols-outlined" style={{ fontSize: '24px' }} >attach_money</span>
 </div>
 ...
 Manajemen keuangan dan pemantauan mutasi kas ormawa secara real-time.
 </p>
 </div>
 
 <Button onClick={() => { setForm({ Deskripsi: '', Nominal: '', Tipe: 'pemasukan', Tanggal: '', OrmawaID: ormawaId }); setIsCrudOpen(true) }} className="h-12 px-6 rounded-2xl bg-[#00236F] text-white hover:bg-[#003399] font-black text-[10px] tracking-widest shadow-xl shadow-blue-900/20 gap-2 w-full md:w-auto shrink-0">
 <span className="material-symbols-outlined size-4 stroke-[3px]" >add</span> Catat Transaksi
 </Button>
 </div>
 </section>
 ...
 <div>
 <p className="text-[10px] font-black text-slate-400 tracking-[0.15em] mb-1 font-headline">{label}</p>
 ...
 <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none"><span className="material-symbols-outlined size-24 rotate-12" >attach_money</span></div>
 ...
 <Badge className="text-[9px] font-black tracking-widest px-2.5 py-0.5 bg-primary/5 text-primary border-none">Kas Registry</Badge>
 </div>
 <DialogTitle className="text-lg md:text-2xl font-black font-headline tracking-tighter text-slate-900 ">Catat Transaksi Baru</DialogTitle>
 ...
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Keterangan</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Jenis</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Jumlah (Rp)</Label>
 <Input required type="number" value={form.Nominal} onChange={e => setForm({ ...form, Nominal: e.target.value })} placeholder="0"
 className="h-12 rounded-2xl border-slate-200 bg-slate-50/50 focus:bg-white transition-all font-bold text-sm font-headline" />
 </div>
 </div>
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Tanggal Transaksi</Label>
 ...
 <span className="text-[9px] md:text-[10px] font-black tracking-[0.2em]">Simpan Transaksi</span>
 </Button>
 </DialogFooter>
 </form>
 </DialogContent>
