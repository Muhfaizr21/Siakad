...
export default function LpjManagement() {
 ...
 <span className="text-[10px] text-slate-400 font-bold tracking-tight mt-0.5">{row.Proposal?.Judul || 'Laporan Pertanggungjawaban'}</span>
 </div>
 )
 },
 {
 ...
 Manajemen pengajuan dan laporan pertanggungjawaban kegiatan organisasi.
 </p>
 </div>
 ...
 <span className="material-symbols-outlined size-4 stroke-[3px]" >add</span> Buat LPJ Baru
 </Button>
 </div>
 </section>
 ...
 <div>
 <p className="text-[10px] font-black text-slate-400 tracking-widest mb-1">LPJ-{selected.ID}</p>
 ...
 <div><p className="text-[9px] font-black text-slate-500 tracking-widest">Anggaran</p><p className="text-sm font-black text-white font-headline">{formatRp(selected.TotalAnggaran)}</p></div>
 <div><p className="text-[9px] font-black text-slate-500 tracking-widest">Realisasi</p><p className="text-sm font-black text-emerald-400 font-headline">{formatRp(selected.RealisasiAnggaran)}</p></div>
 </div>
 </div>
 </div>
 ...
 {selected.Catatan && (
 <div>
 <p className="text-[9px] font-black text-slate-400 tracking-widest mb-2 font-headline">Catatan</p>
 ...
 <Button onClick={() => { setIsDetailOpen(false); handleOpenEdit(selected) }} className="text-[10px] font-black h-10 px-8 rounded-2xl bg-primary text-white">Edit LPJ</Button>
 </div>
 </div>
 </div>
 )}
 ...
 <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none"><span className="material-symbols-outlined size-24 rotate-12" >assignment_turned_in</span></div>
 <div className="relative z-10">
 ...
 <Badge className="text-[9px] font-black tracking-widest px-2.5 py-0.5 bg-primary/5 text-primary border-none">LPJ Registry</Badge>
 </div>
 <DialogTitle className="text-lg md:text-2xl font-black font-headline tracking-tighter text-slate-900 ">{isEditMode ? 'Edit LPJ' : 'Buat Laporan Baru'}</DialogTitle>
 ...
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Pilih Proposal Kegiatan</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Judul Laporan</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Total Anggaran (Rp)</Label>
 <Input required type="number" value={form.TotalAnggaran} onChange={e => setForm({ ...form, TotalAnggaran: e.target.value })} placeholder="0"
 className="h-12 rounded-2xl border-slate-200 bg-slate-50/50 focus:bg-white transition-all font-bold text-sm font-headline" />
 </div>
 <div className="space-y-2">
 <Label className="text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Realisasi (Rp)</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[9px] md:text-[10px] font-black text-slate-400 tracking-[0.2em] ml-1 font-headline">Catatan & Evaluasi</Label>
 ...
 <span className="text-[9px] md:text-[10px] font-black tracking-[0.2em]">{isEditMode ? 'Update Record' : 'Submit LPJ'}</span>
 </Button>
 </DialogFooter>
 </form>
 </DialogContent>
