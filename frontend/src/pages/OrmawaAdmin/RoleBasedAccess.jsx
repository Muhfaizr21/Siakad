        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-slate-500">
              ...
              <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-slate-600">Otorisasi & Keamanan</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-black tracking-tight font-headline text-slate-900">Otoritas & Hak Akses</h1>
                <p className="text-slate-500 text-sm font-medium mt-1">Konfigurasi tata kelola otorisasi modul, hak istimewa role, dan kendali keamanan sistem.</p>
              </div>
            </div>
          </div>
