                ...
                <div className="flex items-center justify-between border-t border-[var(--theme-border-muted)] pt-4 mt-auto">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="p-1.5 text-[var(--theme-text-muted)] hover:text-[var(--theme-warning)] hover:bg-[var(--theme-warning-light)] rounded-lg transition-colors cursor-pointer"
                    ...
                    <button
                      onClick={() => { setSelectedRoleKey(role.ID || role.id); setActiveTab('permissions'); }}
                      className="h-8 px-3 rounded-lg text-[10px] font-bold uppercase tracking-widest text-[var(--theme-primary)] hover:bg-[var(--theme-primary-light)] transition-colors cursor-pointer ml-1"
                    >
                      Configure Matrix
                    </button>
                  </div>
      ...
      >
        <form id="crud-role-form" onSubmit={handleSaveRoleInfo} className="flex flex-col space-y-5">
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-bold text-[var(--theme-text-muted)] tracking-widest uppercase mb-1.5">Nama Otoritas Role</Label>
            <Input
              required
              value={form.Nama}
              onChange={e => setForm({ ...form, Nama: e.target.value })}
              placeholder="Misal: Kaprodi, Sekretaris Prodi, Staff..."
              className="h-11 rounded-xl border-[var(--theme-border)] bg-[var(--theme-bg)] focus:bg-[var(--theme-surface)] focus:border-[var(--theme-primary)] focus:ring-2 focus:ring-[var(--theme-primary-light)] shadow-none transition-all font-semibold text-sm text-[var(--theme-text)]"
            />
          </div>

          {/* Deskripsi */}
          <div className="space-y-1.5">
            <Label className="text-[10px] font-bold text-[var(--theme-text-muted)] tracking-widest uppercase mb-1.5">Tanggung Jawab Singkat</Label>
            <Input
