            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              {activeTab === 'applications' && uniqueScholarships.length > 0 && (
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black text-[#a3a3a3] uppercase tracking-widest whitespace-nowrap">Filter Beasiswa:</span>
                  <Select value={selectedScholarshipFilter} onValueChange={setSelectedScholarshipFilter}>
                    <SelectTrigger className="h-9 w-48 rounded-xl border-slate-200 bg-white font-semibold text-xs shadow-sm focus:ring-primary/20 px-3 py-1 flex items-center justify-between">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="rounded-2xl border-slate-200 shadow-xl p-1 font-body">
                      ...
                      <tr key={row.ID || i} className="border-b border-[#f5f5f5] hover:bg-[#fafbff] transition-colors">
                        ...
                        <td className="px-5 py-3.5">
                          ...
                          <div className="flex flex-col gap-0.5 mt-1">
                            <span className="text-[10px] text-[#a3a3a3] font-medium">Min. IPK {row.MinIPK || '3.00'}</span>
                        ...
                        <td className="px-5 py-3.5">
                          <button onClick={() => setSelectedProgram(row)}
                            className="p-1.5 text-[#a3a3a3] hover:text-primary hover:bg-[#eef4ff] rounded-lg transition-colors" title="Lihat Pendaftar">
                      ...
                      <tr key={row.ID || i} className="border-b border-[#f5f5f5] hover:bg-[#fafbff] transition-colors">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="flex flex-col gap-0.5 mt-0.5">
                                <span className="text-[10px] text-[#a3a3a3] font-medium">{row.Mahasiswa?.NIM || '—'}</span>
                                <span className="text-[10px] text-slate-400 font-semibold">
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-1">
                            <button onClick={() => setPreviewApp(row)}
                              className="p-1.5 text-[#a3a3a3] hover:text-primary hover:bg-[#eef4ff] rounded-lg transition-colors" title="Lihat Pendaftaran">
                              <span className="material-symbols-outlined" style={{ fontSize: 16 }}>visibility</span>
                            </button>
                            <button onClick={() => { 
                              setSelectedApp(row); 
                              ...
                              className="p-1.5 text-[#a3a3a3] hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="Review/Edit">
              ...
              <div className="relative bg-gradient-to-br from-[#00236F] via-[#00308F] to-[#003db5] pt-6 pb-7 px-6 overflow-hidden flex-shrink-0">
                ...
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <h2 className="text-base font-extrabold text-white leading-tight truncate">{previewApp.Mahasiswa?.Nama}</h2>
