        ...
        <div className="space-y-6">
          ...
          <div className="bg-[var(--theme-surface)] rounded-2xl border border-[var(--theme-border)] shadow-sm overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-[var(--theme-border)]">
              <Link to="/admin/tenagakes/list" className="p-6 hover:bg-[var(--theme-bg)] transition-all duration-300 group text-left flex flex-col justify-between">
                <div>
              ...
              <Link to="/admin/tenagakes/bookings" className="p-6 hover:bg-[var(--theme-bg)] transition-all duration-300 group text-left flex flex-col justify-between">
                <div>
              ...
              <Link to="/admin/tenagakes/medical-records" className="p-6 hover:bg-[var(--theme-bg)] transition-all duration-300 group text-left flex flex-col justify-between">
                <div>
