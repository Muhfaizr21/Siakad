          ...
          <main className="pl-80 flex flex-col min-h-screen w-full">
            ...
            <div className="p-8 space-y-8">
              <header className="flex justify-between items-end">
                <div>
                  <h1 className="text-3xl font-extrabold text-primary tracking-tight font-headline uppercase tracking-widest italic">Security Node & Protocol</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <section className="bg-white p-12 rounded-[3.5rem] border border-outline-variant/30 space-y-12 shadow-sm relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-black text-primary uppercase tracking-widest font-headline italic">Global Identity Protocol</h3>
                        <div className="space-y-6">
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="p-6 bg-surface-container-low border border-outline-variant/10 rounded-[2rem] space-y-4">
                                    ...
                                    <p className="text-xs text-secondary/60 font-medium font-body leading-relaxed italic opacity-80 border-t border-outline-variant/10 pt-4 mt-2">Access to the Super Admin panel is strictly prohibited from non-whitelisted IP addresses.</p>
                                </div>
                            </div>
                    ...
                    <section className="bg-secondary-container p-12 rounded-[3.5rem] border border-secondary/20 space-y-12 shadow-sm relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-black text-primary uppercase tracking-widest font-headline italic">Active Administrative Sessions</h3>
                        <div className="space-y-6">
                            {[ 
                                ...
                                <div key={i} className="p-8 bg-white/40 border border-white/20 rounded-[2.5rem] flex items-center justify-between group hover:bg-white/60 transition-all border-dashed shadow-sm">
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] font-black uppercase text-secondary/60 tracking-widest italic">{session.device} • {session.ip}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col items-end">
                                        ...
                                        <span className="text-[10px] text-secondary/40 font-black tracking-widest italic mt-1">{session.status}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
