            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <Button 
                        variant="outline"
                        onClick={loadData}
                        className="h-11 px-6 rounded-xl border-neutral-200 bg-white text-neutral-600 hover:bg-neutral-50 shadow-sm gap-2 transition-all active:scale-95 animate-fade-in"
                    >
                                ...
                                <div className="space-y-2.5 max-w-[140px]">
                                    ...
                                    <div className="w-full h-1.5 bg-neutral-100 rounded-full overflow-hidden">
                                        <div className={cn('h-full transition-all duration-1000 rounded-full', 
                                            ...
                                            asp.Status === 'Proses' ? 'w-[60%] bg-primary shadow-[0_0_8px_rgba(0,102,255,0.3)]' : 
                                            asp.Status === 'Disetujui Fakultas' ? 'w-[40%] bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.3)]' : 'w-[20%] bg-neutral-300')} />
                                    </div>
                                </div>
                            </td>
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4 transition-all duration-300"
          ...
          <div className="relative w-full max-w-5xl bg-white rounded-3xl shadow-2xl z-[101] flex flex-col overflow-hidden max-h-[90vh] animate-scale-up"
            ...
            {/* Modal Header */}
            <div className="relative bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] pt-6 pb-6 px-8 overflow-hidden flex-shrink-0 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="text-lg font-black text-white leading-tight font-jakarta uppercase truncate max-w-[500px] mt-0.5">
