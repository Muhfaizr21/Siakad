...
import { Loader2, Plus, Trash2, Save, LayoutTemplate, BarChart3, BookOpen, MapPin, MessageSquare, Newspaper, MousePointerClick, Info, Phone, Mail, Clock, Scale } from 'lucide-react';
  ...
  return (
    <div className="mt-3">
      ...
      <button
        type="button"
        onClick={() => append({ name: '' })}
        className="mt-2 flex items-center text-xs text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-2 py-1 rounded transition-colors"
      >
  ...
  const fetchSettings = async () => {
    try {
      ...
      if (res?.data) {
        ...
        try { parsedStats = JSON.parse(res.data.stats_json || '[]'); } catch(e) {}
          ...
          <form id="landing-settings-form" onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className={activeMainTab === 'beranda' ? 'block' : 'hidden'}>
              ...
              <div className={`p-6 space-y-6 ${activeBerandaTab === 'hero' ? 'block' : 'hidden'}`}>
                ...
                <div>
                  ...
                  <input {...register("hero_badge")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Utama</label>
                  <input {...register("hero_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Subjudul</label>
                  <textarea {...register("hero_subtitle")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                </div>

                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Statistik Bawah Hero</h3>
                    <button type="button" onClick={() => appendStats({ value: '', label: '' })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'stats' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input {...register("stats_section_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Seksi</label>
                  <input {...register("stats_section_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("stats_section_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Daftar Fakta & Angka</h3>
                    <button type="button" onClick={() => appendStatsList({ icon: '', value: '', label: '' })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
                      <Plus className="w-4 h-4 mr-1" /> Tambah
                    </button>
                  </div>
                  <div className="space-y-3">
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'programs' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Badge / Pre-title</label>
                  <input {...register("programs_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Seksi</label>
                  <input {...register("programs_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("programs_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Daftar Fakultas & Program Studi</h3>
                    <button type="button" onClick={() => appendPrograms({ faculty: '', icon: '', programs_array: [] })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
                      <Plus className="w-4 h-4 mr-1" /> Tambah
                    </button>
                  </div>
                  <div className="space-y-4">
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'locations' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Badge / Pre-title</label>
                  <input {...register("locations_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Seksi</label>
                  <input {...register("locations_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("locations_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Daftar Lokasi Kampus</h3>
                    <button type="button" onClick={() => appendLocations({ name: '', file: '', desc: '' })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
                      <Plus className="w-4 h-4 mr-1" /> Tambah
                    </button>
                  </div>
                  <div className="space-y-3">
                      ...
                      <div key={field.id} className="flex flex-col gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 relative">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pr-8">
                          <div>
                            ...
                            <input {...register(`locations_list.${index}.name`)} placeholder="e.g. Bandung" className="w-full px-3 py-2 text-sm border rounded-md focus:ring-1 focus:ring-blue-500 outline-none" />
                          </div>
                          <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1">Nama Kampus</label>
                            <input {...register(`locations_list.${index}.desc`)} placeholder="e.g. Kampus Pusat" className="w-full px-3 py-2 text-sm border rounded-md focus:ring-1 focus:ring-blue-500 outline-none" />
                          </div>
                          <div className="sm:col-span-2">
                            <label className="block text-xs font-medium text-gray-500 mb-1">Alamat Lengkap</label>
                            <input {...register(`locations_list.${index}.address`)} placeholder="e.g. Jl. Soekarno Hatta No. 754" className="w-full px-3 py-2 text-sm border rounded-md focus:ring-1 focus:ring-blue-500 outline-none" />
                          </div>
                          <div className="sm:col-span-2">
                            <label className="block text-xs font-medium text-gray-500 mb-1">Link Google Maps</label>
                            <input {...register(`locations_list.${index}.gmaps_url`)} placeholder="https://maps.app.goo.gl/..." className="w-full px-3 py-2 text-sm border rounded-md focus:ring-1 focus:ring-blue-500 outline-none" />
                          </div>
                          <div className="sm:col-span-2">
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'testimonials' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Badge / Pre-title</label>
                  <input {...register("testimonials_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Seksi</label>
                  <input {...register("testimonials_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("testimonials_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Daftar Testimoni</h3>
                    <button type="button" onClick={() => appendTestimonials({ name: '', role: '', content: '', image: null })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
                      <Plus className="w-4 h-4 mr-1" /> Tambah
                    </button>
                  </div>
                  <div className="space-y-4">
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'news' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Badge / Pre-title</label>
                  <input {...register("news_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Seksi</label>
                  <input {...register("news_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("news_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
            ...
            <div className={`p-6 space-y-6 ${activeBerandaTab === 'cta' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Badge / Pre-title</label>
                  <input {...register("cta_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Utama</label>
                  <input {...register("cta_subtitle")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                  <textarea {...register("cta_desc")} rows={4} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Teks Tombol</label>
                    <input {...register("cta_button_text")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Link Tombol</label>
                    <input {...register("cta_button_link")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'tentang' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input {...register("tentang_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Tentang Universitas Bhakti Kencana" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Slogan Bawah Judul (Subtitle)</label>
                  <textarea {...register("tentang_subtitle")} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Menjadi universitas unggulan..." />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Visi Universitas</label>
                  <textarea {...register("tentang_visi")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan visi universitas di sini" />
                </div>
                <div>
                  ...
                  <textarea {...register("tentang_misi")} rows={5} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Misi 1&#10;Misi 2&#10;Misi 3" />
                </div>
                <div>
                  ...
                  <textarea {...register("tentang_sejarah")} rows={6} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Tuliskan sejarah universitas..." />
                </div>

                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Daftar Pimpinan Universitas</h3>
                    <button type="button" onClick={() => appendTentangLeaders({ name: '', role: '' })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'kontak' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Utama Halaman</label>
                  <input {...register("kontak_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Hubungi Kami" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Slogan Bawah Judul (Subtitle)</label>
                  <textarea {...register("kontak_subtitle")} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Punya pertanyaan? Kami siap membantu Anda." />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input {...register("kontak_email")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="info@ubk.ac.id, pmb@ubk.ac.id" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Nomor Telepon</label>
                    <p className="text-xs text-gray-500 mb-2">Pisahkan dengan koma jika lebih dari satu</p>
                    <input {...register("kontak_phone")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="(022) 1234-5678, (022) 5678-1234" />
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Alamat Kantor Pusat</label>
                  <textarea {...register("kontak_address")} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Jl. Soekarno Hatta No. 754, Bandung 40286" />
                </div>
                <div>
                  ...
                  <textarea {...register("kontak_jam_opr")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Senin - Jumat: 08.00 - 16.00&#10;Sabtu: 08.00 - 12.00" />
                </div>
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'prodi' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Utama Halaman</label>
                  <input {...register("prodi_page_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Program Studi" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Slogan Bawah Judul (Subtitle)</label>
                  <textarea {...register("prodi_page_subtitle")} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Jelajahi berbagai program studi unggulan..." />
                </div>
                <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3 mt-4">
                  <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <p className="text-sm text-blue-800">
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'berita' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Judul Utama Halaman</label>
                  <input {...register("berita_page_title")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Berita & Artikel" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Slogan Bawah Judul (Subtitle)</label>
                  <textarea {...register("berita_page_subtitle")} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Dapatkan informasi terbaru seputar kampus..." />
                </div>
                <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3 mt-4">
                  <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <p className="text-sm text-blue-800">
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'legal' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <textarea {...register("kebijakan_privasi")} rows={15} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="1. Pendahuluan..." />
                </div>
                <div className="pt-4 border-t border-gray-100">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Syarat & Ketentuan</label>
                  <p className="text-xs text-gray-500 mb-2">Gunakan enter (baris baru) untuk memisahkan paragraf. Jangan gunakan tag HTML.</p>
                  <textarea {...register("syarat_ketentuan")} rows={15} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="1. Penerimaan Syarat..." />
                </div>
              </div>
            </div>
            ...
            <div className={`p-6 space-y-6 ${activeMainTab === 'footer' ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea {...register("footer_desc")} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Menjadi universitas unggulan..." />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Copyright Text</label>
                  <input {...register("footer_copyright")} type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Universitas Bhakti Kencana. All rights reserved." />
                </div>
                
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-gray-800">Tautan Sosial Media</h3>
                    <button type="button" onClick={() => appendSocials({ platform: '', url: '' })} className="flex items-center text-sm text-blue-600 hover:text-blue-700">
