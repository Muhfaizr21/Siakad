          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="space-y-1 w-full lg:w-auto">
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-neutral-900 font-jakarta tracking-tight leading-tight">
                Rekam Medis <span className="text-bku-primary italic font-semibold">Psikologi</span>
              </h1>
              <p className="text-neutral-500 font-medium text-xs md:text-sm max-w-2xl leading-relaxed">
                Catatan sesi klinis mahasiswa, hasil observasi psikolog, mood logger, dan rekomendasi tindak lanjut penanganan kesehatan mental.
              </p>
            </div>
