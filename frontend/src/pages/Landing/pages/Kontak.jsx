...
export default function Kontak() {
  ...
  let locations = [];
  try {
    locations = JSON.parse(settings?.locations_items || '[]');
  } catch(e) {}
  if (!locations.length) {
    locations = [
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Form */}
            <AnimatedSection>
              <h2 className="text-2xl font-extrabold font-headline text-[var(--theme-primary)] mb-6">
                Kirim Pesan
              </h2>
              <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/5 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/5 transition-all resize-none"
                  />
                </div>
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-8 py-3 rounded-xl font-bold text-white bg-[var(--theme-primary)] hover:bg-[#152F58] transition-all hover:scale-105 active:scale-95"
                >
            ...
            <AnimatedSection>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="size-12 rounded-xl bg-[var(--theme-primary)]/5 flex items-center justify-center shrink-0">
                    <MapPin className="size-6 text-[var(--theme-primary)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="size-12 rounded-xl bg-[var(--theme-primary)]/5 flex items-center justify-center shrink-0">
                    <Phone className="size-6 text-[var(--theme-primary)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="size-12 rounded-xl bg-[var(--theme-primary)]/5 flex items-center justify-center shrink-0">
                    <Mail className="size-6 text-[var(--theme-primary)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="size-12 rounded-xl bg-[var(--theme-primary)]/5 flex items-center justify-center shrink-0">
                    <Clock className="size-6 text-[var(--theme-primary)]" />
                  </div>
                  <div>
      ...
      <section className="py-16 lg:py-24 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-10">
            ...
            <h2 className="text-2xl font-extrabold font-headline text-[var(--theme-primary)]">
              ...
              <AnimatedSection key={idx}>
                <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-lg transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    <MapPin className="size-5 text-[var(--theme-secondary)] shrink-0 mt-0.5" />
                    <h3 className="font-bold font-headline text-[var(--theme-primary)]">{loc.name}</h3>
                  </div>
