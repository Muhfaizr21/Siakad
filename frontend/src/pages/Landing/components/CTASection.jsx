...
export default function CTASection({ settings }) {
  ...
  const buttonLink = settings?.cta_button_link || '/register'

  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-[var(--theme-primary)]" />
      <div className="absolute top-0 right-0 w-96 h-96 bg-[var(--theme-secondary)]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-3xl" />

      {/* Pattern */}
      <div className="absolute inset-0 opacity-5 bg-[var(--theme-primary)]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-sm font-bold uppercase tracking-widest text-[var(--theme-secondary)] mb-4">
            {title}
          </p>
