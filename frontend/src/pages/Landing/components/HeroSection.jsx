...
export default function HeroSection({ settings }) {
  ...
  const badgeText = settings?.hero_badge || 'Penerimaan Mahasiswa Baru 2026/2027 Telah Dibuka';
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Decorative Elements */}
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[var(--theme-secondary)]/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
        <div className="max-w-3xl">
          ...
          {badgeText && (
            ...
            >
              <Sparkles className="size-4 text-[var(--theme-secondary)]" />
          ...
          >
            <Link
              to="/register"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-base font-bold text-white bg-[var(--theme-secondary)] hover:bg-[#B8973E] transition-all hover:scale-105 active:scale-95"
            >
              Daftar Sekarang
