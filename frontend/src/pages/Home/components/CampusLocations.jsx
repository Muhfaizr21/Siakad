    ...
    <section className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--theme-bg)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="font-light text-base sm:text-lg italic leading-relaxed max-w-2xl mx-auto" style={{ color: 'var(--theme-text-muted)' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {cities.map((city, i) => (
            <div
              key={i}
              className="border rounded-3xl overflow-hidden transition-all duration-300 flex flex-col relative group"
              style={{
