...
const Scores = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-6">Rekap Nilai Peserta Fakultas</h1>
        ...
        {isLoading ? (
          ...
          <table className="w-full text-left">
            ...
            <tbody>
                ...
                <tr key={s.id} className="border-b border-slate-100 last:border-0">
                  ...
                  <td className="py-4">
                    <span className={`px-2 py-1 rounded text-xs font-bold ${
                      s.is_passed ? 'bg-blue-100 text-blue-700' : 'bg-rose-100 text-rose-700'
                    }`}>
              ...
              {!scores?.length && (
                <tr><td colSpan="6" className="py-4 text-center text-slate-500">Belum ada data nilai dari fakultas ini.</td></tr>
              )}
            </tbody>
          </table>
        )}
