      ...
      {showStageModal && (
        <div className="fixed inset-0 lg:left-72 z-[70] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex justify-between"><h2 className="text-xl font-black text-slate-800 font-headline">{activeStage ? 'Edit Tahap Fakultas' : 'Tambah Tahap Fakultas'}</h2><button onClick={() => setShowStageModal(false)}>x</button></div>
