    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 animate-fade-in font-body">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--theme-primary)] via-[var(--theme-primary-hover)] to-[var(--theme-text)] p-8 md:p-12 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/90 text-xs font-semibold uppercase tracking-widest mb-4 backdrop-blur-md">
      ...
      {!isProfileComplete && (
        <div className="bg-[var(--theme-warning-light)] border border-[var(--theme-warning)] rounded-2xl p-5 flex items-start gap-4 shadow-sm">
          ...
          <div>
            ...
            <Link to="/kencana-mentor/settings" className="inline-block mt-3 text-xs font-semibold text-[var(--theme-warning)] uppercase tracking-wider hover:opacity-85 border-b border-[var(--theme-warning)] pb-0.5 transition-all">Lengkapi Profil &rarr;</Link>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--theme-surface)] rounded-2xl p-6 border border-[var(--theme-border)] shadow-sm hover:-translate-y-0.5 transition-all group relative overflow-hidden flex flex-col justify-between">
          ...
          <Link to="/kencana-mentor/invite" className="inline-flex items-center gap-2 font-semibold text-[var(--theme-primary)] hover:text-[var(--theme-primary-hover)] transition-colors mt-4 relative z-10 text-sm">
      ...
      <div className="bg-[var(--theme-surface)] rounded-2xl border border-[var(--theme-border)] shadow-sm overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-[var(--theme-border)]">
          <Link to="/kencana-mentor/groups" className="p-8 hover:bg-[var(--theme-bg)] transition-colors group">
          ...
          <Link to="/kencana-mentor/invite" className="p-8 hover:bg-[var(--theme-bg)] transition-colors group">
          ...
          <Link to="/kencana-mentor/settings" className="p-8 hover:bg-[var(--theme-bg)] transition-colors group">
