                ...
                <div className="space-y-3.5">
                  {bookings.length > 0 ? (
                    bookings.slice(0, 2).map((booking) => (
                      ...
                      >
                        <div className="w-11 h-11 rounded-[1.25rem] bg-primary/5 text-primary flex items-center justify-center font-black text-xs group-hover:scale-105 transition-transform duration-300 shrink-0 shadow-sm">
                          {booking.name.split(' ').slice(0, 2).map(n => n[0]).join('').toUpperCase()}
                        </div>
