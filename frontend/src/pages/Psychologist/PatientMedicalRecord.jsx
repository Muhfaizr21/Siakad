...
export default function PatientMedicalRecord() {
   ...
   // Lock button if: last session is Tuntas (Selesai)
   const isSessionFinished = lastSessionTuntas === true || patient.status === 'Selesai';
   ...
   return (
      <>
         ...
         <DialogModal
            ...
            title="Tambah Sesi Baru (Asesmen & Rekomendasi)"
            subtitle={bookingId ? `Terhubung ke booking #${bookingId}` : 'Form Asesmen dan Rekomendasi Hasil Konseling'}
            icon="post_add"
            maxWidth="max-w-3xl"
            footer={
               <>
                  <ModalCancelButton onClick={() => setIsModalOpen(false)} />
                  <ModalSaveButton type="submit" form="add-record-form" icon="save">Simpan Catatan</ModalSaveButton>
               </>
            }
         >
