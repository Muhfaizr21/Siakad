          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className="flex items-center gap-2.5 cursor-pointer group hover:bg-slate-50 p-1 pr-3 rounded-full transition-all duration-300 outline-none border border-slate-200/60 bg-white shadow-sm hover:shadow-md">
                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-bku-primary to-indigo-500 text-white flex items-center justify-center font-black text-sm ring-2 ring-white shadow-md shadow-bku-primary/20 group-hover:scale-105 transition-transform shrink-0 overflow-hidden">
