...
fs.writeFileSync('d:/siakad/frontend/src/pages/Student/scratch/audit_report.json', JSON.stringify(report, null, 2));
console.log(`Audited ${allFiles.length} files. Report saved.`);
