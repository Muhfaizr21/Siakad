...
const NOTIF_CATEGORIES = [
  { id: 'EmailAchievement', label: 'Prestasi', desc: 'Update verifikasi dan penolakan laporan prestasi.', icon: Trophy, color: 'text-[#00236F] bg-[#EAF1FF]' },
  { id: 'EmailBeasiswa', label: 'Beasiswa', desc: 'Perubahan status pengajuan dan pengingat deadline beasiswa.', icon: BookOpen, color: 'text-[#0B4FAE] bg-[#EEF4FF]' },
  { id: 'EmailCounseling', label: 'Konseling', desc: 'Konfirmasi booking dan pengingat sesi konseling.', icon: HeartHandshake, color: 'text-[#1D4E9E] bg-[#EDF3FF]' },
  { id: 'EmailVoice', label: 'Student Voice', desc: 'Notifikasi saat aspirasi atau pengaduanmu direspons admin.', icon: MessageSquare, color: 'text-[#113A80] bg-[#F3F7FF]' },
  { id: 'EmailKencana', label: 'KENCANA', desc: 'Pengingat kuis dan materi yang belum diselesaikan.', icon: GraduationCap, color: 'text-[#294D8D] bg-[#EEF4FF]' },
  { id: 'EmailNews', label: 'Pengumuman Kampus', desc: 'Berita dan informasi terbaru dari pihak universitas.', icon: Bell, color: 'text-[#2A4C86] bg-[#EDF3FF]' },
];
      ...
      <div className="bg-white rounded-3xl border border-[#e5e5e5] p-6 md:p-8 shadow-sm">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="mt-10 p-5 rounded-2xl bg-[#EAF1FF] border border-[#C9D8FF] flex items-start gap-3">
             <Info className="text-[#0B4FAE] shrink-0 mt-0.5" size={18} />
