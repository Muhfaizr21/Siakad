                ...
                riwayat.map((rec) => {
                  ...
                  return (
                    <tr key={rec.id} className="group hover:bg-[var(--theme-bg)] transition-colors">
                      ...
                      {/* Status */}
                      <td className="px-5 py-4 text-center">
                        <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase ${rec.status_kesehatan === 'sehat' ? 'bg-emerald-50 text-emerald-600' : 'bg-blue-50 text-blue-600'
                          }`}>
  ...
  return (
    <DialogModal
      ...
      footer={
        <div className="flex gap-3 w-full">
          <button
            onClick={onClose}
            className="flex-1 py-3 bg-white border border-border text-[var(--theme-text-muted)] text-[13px] font-black rounded-xl hover:bg-slate-50 transition-all uppercase tracking-widest cursor-pointer"
          >
            Batal
          </button>
          <button
            ...
            className="flex-1 py-3 bg-[var(--theme-primary)] text-white text-[13px] font-black rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-50 shadow-md shadow-blue-900/20 uppercase tracking-widest cursor-pointer border-none"
          >
            {isLoading
    ...
    >
      <div className="flex flex-col md:flex-row gap-6">
        {/* Sidebar Analytics */}
        <div className="w-full md:w-72 bg-blue-50/50 border border-blue-100 p-6 rounded-3xl shrink-0 h-fit space-y-6">
          <div className="flex items-center gap-3 border-b border-blue-100 pb-4">
            <div className="w-10 h-10 rounded-2xl bg-white border border-blue-100 shadow-sm flex items-center justify-center text-blue-600">
              <span className="material-symbols-outlined animate-pulse" style={{ fontSize: '20px' }}>show_chart</span>
            </div>
            <h2 className="text-[12px] font-black uppercase tracking-widest text-blue-900">Live Analytics</h2>
          </div>

          <div className="space-y-6">
            {/* BMI Live */}
            <div className="bg-white p-4 rounded-2xl border border-blue-50 shadow-sm">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">BMI Meter</p>
              <div className="flex items-baseline gap-1.5 mb-2">
                <span className="text-3xl font-black tracking-tight text-slate-800">{bmi || '–'}</span>
            ...
            {/* BP Live */}
            <div className="bg-white p-4 rounded-2xl border border-blue-50 shadow-sm">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Tekanan Darah</p>
              <div className="text-2xl font-black tracking-tight mb-2 text-slate-800">
                {formData.sistolik || '–'}<span className="text-slate-300 font-medium">/</span>{formData.diastolik || '–'}
              </div>
              <span className={`text-[10px] font-bold uppercase ${bpStat.label === 'Belum Ada Data' ? 'text-slate-400' : bpStat.color}`}>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="border border-slate-200 rounded-3xl p-5 bg-white space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              <span className="material-symbols-outlined text-blue-600 font-bold" style={{ fontSize: '20px' }}>accessibility_new</span>
              <span className="text-[11px] font-black text-blue-900 uppercase tracking-widest">1. Kategori Fisik</span>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <InputField label="Tinggi Badan" unit="cm" value={formData.tinggi_badan} onChange={v => setFormData(p => ({ ...p, tinggi_badan: v }))} icon={<span className="material-symbols-outlined text-blue-500 font-bold" style={{ fontSize: '16px' }}>straighten</span>} placeholder="170" />
              <InputField label="Berat Badan" unit="kg" value={formData.berat_badan} onChange={v => setFormData(p => ({ ...p, berat_badan: v }))} icon={<span className="material-symbols-outlined text-blue-500 font-bold" style={{ fontSize: '16px' }}>scale</span>} placeholder="65" />
            </div>
          </div>
          ...
          <div className="border border-slate-200 rounded-3xl p-5 bg-white space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              <span className="material-symbols-outlined text-teal-600 font-bold" style={{ fontSize: '20px' }}>sports_gymnastics</span>
              <span className="text-[11px] font-black text-teal-900 uppercase tracking-widest">2. Gaya Hidup (Self-report)</span>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-teal-500 font-bold" style={{ fontSize: '16px' }}>bedtime</span> Jam Tidur / Hari
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-teal-500 font-bold" style={{ fontSize: '16px' }}>fitness_center</span> Olahraga / Minggu
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-teal-500 font-bold" style={{ fontSize: '16px' }}>local_drink</span> Air Minum (L)
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-teal-500 font-bold" style={{ fontSize: '16px' }}>smoke_free</span> Apakah Merokok?
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
          ...
          <div className="border border-slate-200 rounded-3xl p-5 bg-white space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              <span className="material-symbols-outlined text-purple-600 font-bold" style={{ fontSize: '20px' }}>psychology</span>
              <span className="text-[11px] font-black text-purple-900 uppercase tracking-widest">3. Kategori Mental (Self-report)</span>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between items-center mb-2">
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5">
                  Tingkat Stres (1-10)
                </label>
                <span className="px-3 py-1 text-[13px] font-extrabold bg-purple-100 text-purple-700 rounded-xl">{formData.tingkat_stres}</span>
              </div>
              <input
                type="range"
                min="1"
                max="10"
                className="w-full accent-purple-600 bg-slate-100 h-2 rounded-xl appearance-none cursor-pointer"
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-purple-500 font-bold" style={{ fontSize: '16px' }}>mood</span> Mood Minggu Ini
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
                  value={formData.mood}
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                  <span className="material-symbols-outlined text-purple-500 font-bold" style={{ fontSize: '16px' }}>auto_stories</span> Motivasi Belajar
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
          ...
          <div className="border border-slate-200 rounded-3xl p-5 bg-white space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              <span className="material-symbols-outlined text-red-600 font-bold" style={{ fontSize: '20px' }}>healing</span>
              <span className="text-[11px] font-black text-red-900 uppercase tracking-widest">4. Kategori Keluhan (Bila Ada)</span>
            </div>
              ...
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-2xl border text-left text-[13px] font-bold transition-all cursor-pointer ${formData[item.key]
                      ? 'bg-rose-50 border-rose-200 text-rose-600 shadow-sm ring-2 ring-rose-500/10'
          ...
          <div className="border border-slate-200 rounded-3xl p-5 bg-white space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              <span className="material-symbols-outlined text-indigo-600 font-bold" style={{ fontSize: '20px' }}>query_stats</span>
              <span className="text-[11px] font-black text-indigo-900 uppercase tracking-widest">5. Kategori Opsional (Alat/Klinik)</span>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <InputField label="Tensi Sistolik" unit="mmHg" value={formData.sistolik} onChange={v => setFormData(p => ({ ...p, sistolik: v }))} icon={<span className="material-symbols-outlined text-indigo-500 font-bold" style={{ fontSize: '16px' }}>arrow_upward</span>} placeholder="120" isOptional={true} />
              <InputField label="Tensi Diastolik" unit="mmHg" value={formData.diastolik} onChange={v => setFormData(p => ({ ...p, diastolik: v }))} icon={<span className="material-symbols-outlined text-indigo-500 font-bold" style={{ fontSize: '16px' }}>arrow_downward</span>} placeholder="80" isOptional={true} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <InputField label="Gula Darah" unit="mg/dL" value={formData.gula_darah} onChange={v => setFormData(p => ({ ...p, gula_darah: v }))} icon={<span className="material-symbols-outlined text-indigo-500 font-bold" style={{ fontSize: '16px' }}>water_drop</span>} placeholder="90" isOptional={true} />
              <div>
                <label className="text-[11px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 mb-2 justify-between">
                  <span className="flex items-center gap-1.5">
                    <span className="material-symbols-outlined text-indigo-500 font-bold" style={{ fontSize: '16px' }}>bloodtype</span> Golongan Darah
                  </span>
                  <span className="text-[9px] font-extrabold px-2 py-1 rounded-md bg-slate-100 text-slate-400 border border-slate-200 normal-case tracking-normal">Opsional</span>
                </label>
                <select
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-bold focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all text-slate-800"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-[13px] font-medium focus:outline-none focus:border-[var(--theme-primary)] focus:ring-4 focus:ring-[var(--theme-primary)]/10 transition-all resize-none text-slate-800 placeholder:text-slate-400"
    ...
    <Dialog open={true} onOpenChange={onClose} maxWidth="max-w-lg">
      <DialogContent>
        ...
        <div className="p-8 overflow-y-auto max-h-[50vh] no-scrollbar space-y-5 text-left bg-white">
          ...
          {delta && (
            <div className={`p-4 rounded-2xl border ${delta.type === 'success' ? 'bg-emerald-50/50 border-emerald-100 text-emerald-900' :
