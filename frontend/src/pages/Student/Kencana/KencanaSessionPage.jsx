          ...
          <section className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              {(data?.quizzes || []).map((q) => {
                ...
                return (
                  <div key={q.id} className="rounded-2xl border border-slate-100 bg-blue-50 overflow-hidden">
          ...
          <section className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-4">
              {(data?.assignments || []).map((a) => {
                ...
                return (
                  <Link key={a.id} to={`/student/kencana/assignment/${a.id}`} className="block rounded-2xl border border-slate-100 bg-blue-50 hover:bg-blue-100 transition-colors overflow-hidden">
