...
export function LoadingPanel() {
  return <div className="rounded-2xl border border-border bg-[var(--theme-surface)]/70 p-8 text-sm font-bold text-[var(--theme-text-muted)]">Memuat data Kencana...</div>;
}

export function ErrorPanel({ message = 'Data belum tersedia.' }) {
  return <div className="rounded-2xl border border-[var(--theme-error)]/25 bg-[var(--theme-error)]/10 p-8 text-sm font-bold text-[var(--theme-error)]">{message}</div>;
}
