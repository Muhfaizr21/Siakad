        ...
        <section className="mb-6 rounded-3xl bg-[var(--theme-primary)] p-8 shadow-xl text-white flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-medium text-white/80 max-w-lg leading-relaxed">Sertifikat kelulusan Anda telah diterbitkan resmi oleh Universitas. Gunakan sertifikat ini sebagai bukti kelulusan orientasi.</p>
            </div>
          </div>
          <a href={certData.certificate.file_url} target="_blank" rel="noreferrer" className="relative z-10 flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-sm font-black text-[var(--theme-primary)] transition hover:bg-white/90 shadow-lg hover:-translate-y-1 hover:shadow-xl shrink-0">
