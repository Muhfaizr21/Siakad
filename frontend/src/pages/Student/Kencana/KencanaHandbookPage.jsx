  ...
  return (
    <KencanaShell title="Handbook Mahasiswa" subtitle="Handbook wajib diisi dan disetujui agar bisa lulus penuh.">
      <section className="grid gap-5 lg:grid-cols-[1fr_0.45fr]">
        <div className="rounded-2xl border border-border bg-white/85 p-6 shadow-sm space-y-4">
        ...
        <aside className="rounded-2xl border border-border bg-white/85 p-6 shadow-sm">
