            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col gap-1 pt-1 border-b border-[#f5f5f5] pb-4 group-last/item:border-0">
                   <p className="text-sm font-bold text-[#171717] leading-snug group-hover/item:text-[#f97316] transition-colors">
                      {item.deskripsi}
                   </p>
